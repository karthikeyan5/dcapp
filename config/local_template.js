//make a copy of this file and name it as local.js
   ...
   // environment: process.env.NODE_ENV || 'development'
    ...
    session: { 
      key: 'dev_local_dc.sails.sid' 
         ...
         erpnext_defaults: {
          desk_path_sinv:'/desk#Form/Sales%20Invoice',
          api_path_sinv:'/api/resource/Sales%20Invoice',
          api_path_login:'/api/method/login'
        },
      ...
      // user the below connection for Development

     //   connections: {
     //     default: 'someMysqlServer',
     //      someMysqlServer: {
     //  adapter: 'sails-mysql',
     //  host: 'essdeevpn.cloudapp.net',
     //  user: 'root', //optional
     //  password: 'toor', //optional
     //  database: 'dcdb' //optional
     // }
     // }
